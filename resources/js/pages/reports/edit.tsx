...
import { REPORT_COLUMN_GROUPS } from '@/lib/report-columns';
import { type BreadcrumbItem, type EventModel, type Masjid, type Purpose, type Report, type Squad, type VolunteerType } from '@/types';
...
export default function ReportEdit({
    ...
    const { data, setData, put, processing, errors, transform } = useForm({
        ...
        purpose_id: report.purpose_id ? String(report.purpose_id) : 'none',
        event_id: report.event_id ? String(report.event_id) : 'none',
        squad_id: report.squad_id ? String(report.squad_id) : 'none',
        masjid_id: report.masjid_id ? String(report.masjid_id) : 'none',
        volunteer_type_id: report.volunteer_type_id ? String(report.volunteer_type_id) : 'none',
        columns,
    });
